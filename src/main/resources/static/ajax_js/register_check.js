...
function check_register_repassword() {
    ...
    if (password==repassword){
        //两次密码输入一致
        //alert("===========")
        document.getElementById("repassword").removeAttribute("style")
        document.getElementById("repassword_message").value = "";
...
function checkMessage() {
    ...
    //检查这几个哥们有值没
    if (password==null||username==null||loginname==null||repassword==null||email==null){
        //有哥们为空
        layer.msg('有哥们为空！',{icon:1,time:1000,offset:['120px','600px']})
    }else {
        $("form").submit();
    }
