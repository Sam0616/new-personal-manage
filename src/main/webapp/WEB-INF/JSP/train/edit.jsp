...
<div class="x-body">
    <form class="layui-form" method="POST" id="deptForm" action="${pageContext.request.contextPath}/train/edit">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="startdata" name="startdate" required="" lay-verify="required"
                       autocomplete="off" class="layui-input" value="${train.startdate}">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="enddata" name="enddate" required="" lay-verify="required"
                       autocomplete="off" class="layui-input" value="${train.enddate}">
            </div>
        ...
        <div class="layui-form-item">
            <label for="username" class="layui-form-label">
                <span class="x-red">*</span>培训时长(天) <input type="button" value="计算时长" onclick="check()">
            </label>
            <div class="layui-input-inline">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <select id="completion" name="completion" class="valid">
                    <c:forEach items="${completion_list}" var="line" varStatus="stat">
