...
<%--    <script>--%>
<%--        setTimeout(function () {--%>
<%--            document.getElementById("repassword_message").style.display = "none";--%>
<%--        }, 3000);--%>
<%--        //1000是多久被隐藏，单位毫秒--%>
<%--    </script>--%>
...
<div style="width: 100%;height:48px; background-color:RGB(43,48,59) ">
    <ul style="margin-left: 40px;padding-top:6px">
        <li style="display: inline-block;"><h1><a href="loginForm.html" style="color:white;font-size:20px;">创新创业型小微企业的人力资源管理平台</a>
        </h1></li>
        <li style="display: inline-block; margin-left: 120px;"><p style="font-size:14px;color: rgb(130,130,130)">
            重置密码</p></li>
        <li style="display: inline-block; margin-left: 60px;"><a href="loginForm.html"
        ...
        <div class="register" style="height:360px;margin-top:150px;margin-left:205px; opacity:0.9;">
            <div class="title">
                ...
                <div style="height: 10px;margin-top: 15px;">
                    <input id="updata_message" disabled="disabled" size="50px;" value=""
                           style="background-color:transparent;border:0;color: red"/>
                </div>
            </div>
            <form action="rePassword?" method="post" id="rePasswordForm">
                <div style="height: 10px"></div>

                <div class="default">

                    <input id="loginname" name="loginname" data-form="upwd" type="text" placeholder="此处显示您的登录名 "
                           value="${loginname}" readonly/>
                </div>

                <div class="default" style="margin-top: 16px;">
                    <input id="password" name="password" data-form="uname" type="password"
                           placeholder="新密码  6-16位数字和字母的组合" value=""/>
                </div>

                <div style="height: 10px;margin-top: -10px;">
                    <input id="psd_message" disabled="disabled" value=""
                           style="background-color:transparent;border:0;color: red"/>
                </div>

                <div class="default" style="margin-top: 16px;">
                    <input id="repassword" name="repassword" data-form="uname" type="password" placeholder="请再次输入你的新密码"
                           value=""/>
                </div>
                <div style="height: 10px;margin-top: -10px;">
                    <input id="repassword_message" disabled="disabled" value="${flag}"
                           style="background-color:transparent;border:0;color: red"/>
                </div>
                ...
                <div style="margin-top: -35px;">
                    <div style="height: 10px;margin-top: -10px;">
                        <input id="find_message" disabled="disabled" size="50px;" value="${message}"
                               style="background-color:transparent;border:0;color: red"/>
                    </div>
                </div>
            </form>
