...
<%--                  </c:choose>--%>
                  ...
                  <input type="text" id="card_id" name="card_id" required="" lay-verify="required"   disabled="disabled"
                  autocomplete="off" class="layui-input"  value="${employee.sexId==1? '男':'女'}">
              </div>
          </div>
          ...
          <div class="layui-form-item" >
              ...
              <div class="layui-input-inline">
                  <input type="text" id="card_id" name="card_id" required="" lay-verify="required"   disabled="disabled"
                  autocomplete="off" class="layui-input" value="${eduname}">
              </div>
          </div>
          ...
          <div class="layui-form-item">
           ...
           <div class="layui-form-item" >
              ...
              <div class="layui-input-inline">
                  <input type="text" id="card_id" name="card_id" required="" lay-verify="required"   disabled="disabled"
                  autocomplete="off" class="layui-input" value="${empjobname}">
              </div>
          </div>
          ...
          <div class="layui-form-item" >
              ...
              <div class="layui-input-inline">
                  <input type="text" id="card_id" name="card_id" required="" lay-verify="required"   disabled="disabled"
                  autocomplete="off" class="layui-input" value="${empdeptname}">
              </div>
          </div>
