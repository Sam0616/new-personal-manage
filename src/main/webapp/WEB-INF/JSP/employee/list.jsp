...
<html>
  ...
  <body>
    <div class="x-nav">
      ...
      <button id="aaa" type="button" onclick="location.href='${pageContext.request.contextPath}/employee/association'" class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:innert;margin-left:75%;;"  ><i class="layui-icon"></i>增加</button>
      <a id="bbb" class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right" href="${pageContext.request.contextPath}/employee/list" title="刷新">
          ...
          layui.use('laypage', function () {
              ...
              laypage.render({
                  ...
                  , jump: function (obj, first) {
                      ...
                      if (!first) {
                          //do something
                          window.location.href = "${pageContext.request.contextPath}/employee/list?pageNo=" + obj.curr + "&pageSize=" + obj.limit;
                      }
                  }
              });
          });
