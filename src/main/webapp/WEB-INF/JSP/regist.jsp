		 ...
		 <div id="register"  class="register" style="height:460px;margin-top:100px;margin-left:205px;opacity:0.9;">
            <div class="title">
             ...
             <form  method="post" action="register" name="check-form" id="toLoginForm">
                 ...
                 <div style="height: 10px;margin-top: -10px;">
                     <input id="email_message" type="text" disabled="disabled"  value=""style= "background-color:transparent;border:0;color: red"/>
                 </div>

                 <div class="default">
                     <input id="password" name="password"
                            value="${password}" data-form="upwd" type="password" placeholder="请输入密码   密码 6-12位数字和字母组合" onclick="check_register_password()"/>
                 </div>
                 <div style="height: 10px;margin-top: -10px;">
                 ...
                 <div class="default">
                     <input id="repassword" name="repassword"
                            value="${repassword}" data-form="upwd" type="password" placeholder="请确认密码 " onblur="check_register_repassword()"/>
                 </div>
                 <div style="height: 10px;margin-top: -10px;">
                 ...
                 <div class="submit" style="margin-top: 16px;">
                     <input id="login-submit-btn" class="s_hover" type="button" value="注册" onclick="checkMessage()"/>
                 </div>
