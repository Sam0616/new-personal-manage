...
<body oncontextmenu="self.event.returnValue=false" onselectstart="return false"
      style="overflow: hidden;background-size: cover;  ">
...
<div id="main" style="width:100%;height:705px;float:left;">

    <div class="container" style="background-color:rgb(73,74,95);width: 100%;height:705px;float:left">
        <!-- <div  style="background-color:green;width: 1360px;height:610px; float:left;"> -->
        <!-- 幻灯片 -->

        <div class="testSlider" style="margin-left:-160px;margin-right: -160px;"></div>

        <div id="register" class="register" style="height:370px;margin-top:150px;margin-left:320px;opacity:0.9;">
            <div class="title">
            ...
            <form method="post" action="${pageContext.request.contextPath}/login" name="check-form" id="toLoginForm">
                ...
                <div class="default" style="margin-top:40px;">
                    <input data-form="uname" type="text" placeholder="请输入登录名" onchange="tocheckLoginname()"
                           id="loginname" name="loginname" value="ssssss"/>
                </div>
