     ...
     <tr>
            <td>
              <div class="layui-unselect layui-form-checkbox" lay-skin="primary" data-id='2'><i class="layui-icon">&#xe605;</i></div>
            		  ...
            		  <td>${salary.employeeInf.name}</td>
            		  <td>${salary.jobInf.name }</td>
					  <td>${salary.deptInf.name }</td>
					  ...
					  <td><f:formatDate value="${salary.createDate}"/></td>
            <td class="td-manage">
             
             <a title="编辑"  href='${pageContext.request.contextPath}/salary/toedit?id=${salary.id}'>
                <i class="layui-icon">&#xe642;</i>
              </a>
               <a title="删除" onclick="member_del(this,'${salary.id }')" >
                <i class="layui-icon">&#xe640;</i>
              </a>
            </td>
          </tr>
          ...
          laypage.render({
              ...
              , jump: function (obj, first) {
                  ...
                  if (!first) {
                      //do something
                      //调用后台
                      window.location.href = "${pageContext.request.contextPath}/salary/list?pageNo=" + obj.curr + "&pageSize=" + obj.limit;
                  }
              }
          });
      });
