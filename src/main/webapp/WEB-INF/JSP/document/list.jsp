...
<div class="x-nav">
    ...
    <button id="aaa" type="button" onclick="location.href='${pageContext.request.contextPath}/document/toadd'"
            class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:innert;margin-left:75%;;"
...
<div class="x-body">
    <div class="layui-row" style="" align="center">
        <form class="layui-form layui-col-md12 x-so" method="get"
              action="${pageContext.request.contextPath }/document/list">
    ...
    <table class="layui-table">
        ...
        <c:forEach items="${requestScope.list}" var="doc" varStatus="stat">
            <tr>
                ...
                <td align="center" width="40px;"><a id="down_${doc.filename }">
                    <img width="20" alt="图片丢失" height="20" title="下载"
                         src="${pageContext.request.contextPath }/public/images/downLoad.png"/></a>
                </td>
