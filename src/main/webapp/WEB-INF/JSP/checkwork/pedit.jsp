...
<div class="x-nav">
    ...
    <button id="bbb" type="button" onclick="location.href='${pageContext.request.contextPath}/checkwork/toadd'"
    ...
    <a id="aaa" class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right"
       href="${pageContext.request.contextPath }/checkwork/list" title="刷新">
        <i class="layui-icon" style="line-height:30px">ဂ</i></a>
</div>
<div class="x-body">
    <div class="layui-row" style="" align="center">
        <form class="layui-form layui-col-md12 x-so" method="get"
              action="${pageContext.request.contextPath }/checkwork/pedit">
    ...
    <table class="layui-table">
        ...
        <tbody>
<%--        <c:forEach items="${list}" var="checkwork" varStatus="stat">--%>
            <tr>
                <td>
                    <div class="layui-unselect layui-form-checkbox" lay-skin="primary" data-id='2'><i
                            class="layui-icon">&#xe605;</i></div>
                </td>
                <td>${checkwork.employeeInf.name}</td>
                <td>${checkwork.jobInf.name }</td>
                <td>${checkwork.deptInf.name }</td>
                <td>${checkwork.workingdays}</td>
                <td>${checkwork.daysleave}</td>
                <td>${checkwork.daysout}</td>
                <td><f:formatDate value="${checkwork.createdate}"/></td>
             <%--   <td class="td-manage">

                    <a title="编辑"
                       href='${pageContext.request.contextPath}/checkwork/toedit?id=${checkwork.id}'>
                        <i class="layui-icon">&#xe642;</i>
                    </a>
                    <a title="删除" onclick="member_del(this,'${checkwork.id }')">
                        <i class="layui-icon">&#xe640;</i>
                    </a>
                </td>--%>
            </tr>
