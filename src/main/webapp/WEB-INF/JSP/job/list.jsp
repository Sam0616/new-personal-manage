...
<div class="x-nav">
    ...
    <button id="aaa" type="button" onclick="location.href='${pageContext.request.contextPath}/job/toadd'"
    ...
    <a id="bbb" class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right"
       href="${pageContext.request.contextPath}/job/list" title="刷新">
...
<div class="x-body">
        ...
        <c:forEach items="${requestScope.list}" var="job" varStatus="stat">
            <tr>
                ...
                <td class="td-manage">
                    ...
                    <a title="删除" onclick="member_del(this,'${job.id }')">
                        <i class="layui-icon">&#xe640;</i>
                    </a>
                </td>
            </tr>
            ...
            laypage.render({
                ...
                , jump: function (obj, first) {
                    ...
                    if (!first) {
                        //do something
                        //调用后台
                        window.location.href = "${pageContext.request.contextPath}/job/list?pageNo=" + obj.curr + "&pageSize=" + obj.limit;
                    }
                }
            });
        });
    ...
    <%--    <script>--%>
    <%--        //用户修改--%>
    <%--        //${pageContext.request.contextPath}/job/toedit?id=${job.id}--%>
    <%--        function edit(id) {--%>
    <%--           var pageNum=${pageNum};--%>
    <%--          location.href="/job/toedit?id="+id+"&pageNum="+pageNum;--%>
    <%--        }--%>
    ...
    <%--                  if(!first){--%>
    <%--                      // 调用后台--%>
    <%--                      window.location.href="${pageContext.request.contextPath}/job/list?pageNum="+obj.curr+"&pageSize="+obj.limit;--%>
    <%--                  }--%>
    <%--              }--%>
    <%--          });--%>
    <%--      });--%>
